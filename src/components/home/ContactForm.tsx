          ...
          <div className="glass-card p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="flex-shrink-0 text-festblue-accent">
            ...
            <h3 className="text-2xl font-semibold text-white mt-10 mb-4">Follow Us</h3>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-festblue-accent p-2 rounded-full border border-gray-600 hover:border-festblue-accent transition-colors">
